...
const faqItems = [
  {
    ...
    a: "כרגע הקבוצות מיועדות לבני נוער בגילאי 12-16 בלבד. אני מחפש מתאמנים עם תשוקה אמיתית לספורט ורצון להגיע לרמה גבוהה."
  },
  {
    q: "האם צריך ניסיון קודם?",
    a: "קליסטניקס הוא אימון בעצימות גבוהה. אני לא מצפה לניסיון מקצועי, אבל כן נדרשת יכולת בסיסית של תנועה ושליטה במשקל גוף. המטרה היא להתקדם יחד לרמה גבוהה ולא לבזבז זמן על הבסיס המוטורי."
  },
  {
    q: "מה צריך להביא לאימון?",
    a: "פשוט בגדי ספורט נוחים ונעליים מתאימות. כל הציוד המקצועי מחכה לכם בסטודיו."
  },
  {
    q: "איפה חונים?",
