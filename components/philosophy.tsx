      ...
      <div className="mx-auto grid max-w-6xl items-center gap-16 md:grid-cols-2">
        ...
        >
          <div className="relative h-[30rem] w-[26rem] flex items-center justify-center">
            <div className="absolute top-0 right-0 h-80 w-64 overflow-hidden rounded-2xl border border-border bg-muted shadow-2xl z-10">
              <Image src="/me.png" alt="דיוקן" fill className="object-cover" />
            </div>
            <div className="absolute bottom-0 left-0 h-64 w-60 overflow-hidden rounded-2xl border border-border bg-muted shadow-lg z-0">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <h2 className="text-3xl font-black">הדרך שלי</h2>
