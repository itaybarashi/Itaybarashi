      ...
      <div className="mx-auto max-w-4xl">
        ...
        <Reveal delay={0.1}>
          <p className="mt-8 max-w-2xl text-pretty text-lg leading-relaxed text-muted-foreground">
            תנועה משפיעה באופן ישיר על איך שאנחנו תופסים את המציאות, על איך שאנחנו מרגישים, חושבים וחשים. קליסטניקס היא דרך מדהימה בעיני לפתח כוח ושליטה גבוהה יותר במשקל גוף, הבנה טובה יותר של הגוף והתפתחות מנטלית.
          </p>
        </Reveal>
