      ...
      <div className="mx-auto grid max-w-6xl items-center gap-12 md:grid-cols-2">
        ...
        >
          ...
          <p className="mt-6 text-lg leading-relaxed text-muted-foreground">
            ...
            הרבה חושבים שזה כישרון, או שהתחלתי מנקודת פתיחה גבוהה —
            אבל האמת היא שהתחלתי מאפס.
            <br /><br />
            לא הצלחתי לעשות אפילו מתח אחד,
            ולקח לי יותר מחצי שנה להגיע לעליית הכוח הראשונה שלי.
            תרגילים שלאנשים לוקח כמה חודשים,
            לי לקחו שנים.
            <br /><br />
            דווקא בגלל הדרך הזאת,
            למדתי להבין את הגוף לעומק,
            להתמודד עם כשלונות,
            להבין את החשיבות של התמדה וחזרות,
            ולעבור גם פציעות — וללמוד איך להתגבר עליהן.
            <br /><br />
            מעבר לכוח,
            מצאתי דרך, קהילה, וחברים לחיים שאני איתם עד היום.
            <br /><br />
            האני מאמין שלי הוא פשוט:
            זה לא רק מה שאתה משיג —
